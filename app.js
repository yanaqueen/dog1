...
const pages = {
  ...
  about: `
    <section>
      ...
      <p>שלום! אני יאנה ברגמן, מאלפת כלבים מוסמכת. אני מתמחה בגישה חיובית ואמפתית שמכבדת את הצרכים של הכלב והמשפחה שלו. כל תוכנית אילוף מותאמת אישית, מתוך מטרה לבנות אמון וביטחון וליצור שגרה רגועה ונעימה בבית.</p>
